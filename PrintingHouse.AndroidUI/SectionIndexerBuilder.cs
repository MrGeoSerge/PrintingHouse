...
namespace PrintingHouse.AndroidUI
{
    public static class SectionIndexerBuilder
    {
        ...
        public static Java.Lang.Object[] BuildSectionHeaders(List<Manager> data)
        {
            ...
            {
                var letter = item.LastName[0].ToString();
        ...
        public static Dictionary<int, int> BuildSectionForPositionMap(List<Manager> instructors)
        {
            ...
            {
                var letter = instructors[i].LastName[0].ToString();
        ...
        public static Dictionary<int, int> BuildPositionForSectionMap(List<Manager> instructors)
        {
            var results = new Dictionary<int, int>();
            var used = new SortedSet<string>();
            int section = -1;
